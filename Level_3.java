...
public class Level_3 extends JPanel implements KeyListener,
    ...
    Rectangle[] Brick4 = new Rectangle[20];
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setColor(Color.WHITE);
            ...
            for (Rectangle Brick4_1 : Brick4){
                //if(Brick4_1!=null)
                g.fill3DRect(Brick4_1.x, Brick4_1.y, Brick4_1.width, Brick4_1.height, true);
            }
 ...
 @Override
  ...
  //Creating bricks for the game...
        ...
        Brick4[12] = new Rectangle(brickx-510, bricky+17, 50, 15);
        Brick4[13] = new Rectangle(brickx-51, bricky+17, 50, 15);
        ...
        Brick4[14] = new Rectangle(brickx+306, bricky+34, 50, 15);
        Brick4[15] = new Rectangle(brickx-51, bricky+34, 50, 15);
        
        for (int i = 18; i < 24; i++) {
            Brick[i] = new Rectangle(brickx, bricky+34, 50, 15);
                brickx += 51;
        }
        Brick4[16] = new Rectangle(brickx-306, bricky+51, 50, 15);
        Brick4[17] = new Rectangle(brickx-51, bricky+51, 50, 15);
        
        for (int i = 24; i < 28; i++) {
            Brick[i] = new Rectangle(brickx-102, bricky+51, 50, 15);
                brickx -= 51;
        }
        Brick4[18] = new Rectangle(brickx+102, bricky+68, 50, 15);
        Brick4[19] = new Rectangle(brickx-51, bricky+68, 50, 15);
        ...
        for(int i = 0 ; i < 6; i++){
            Brick4[i] = new Rectangle(brickx-1970, bricky+147, 50, 15);
            brickx += 51;
        }
        
        for(int i = 6 ; i < 12; i++){
            Brick4[i] = new Rectangle(brickx-1818, bricky+147, 50, 15);
            brickx += 51;
        }
 ...
 @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if (str.equals("Try again")) {
            s.hitFrame();
            f.framegameOverL3.setVisible(false);
